...
import { getTopLanguages } from "@/utils/github";
...
export const DetailsSection = ({ stats, loading }: DetailsSectionProps) => {
  return (
    <motion.div
      ...
      >
        <GlassCard className="p-8" glowEffect>
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            I like things to be nice and neat, and love a project that speeds up
            my workflow. I enjoy building tools that help me stay organized and
            make everyday tasks easier.
          </p>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            When I'm not coding, you'll find me immersed in exciting games like
            The Finals, Call of Duty, or Delta Force. These fast-paced shooters
            are packed with action and strategy, making every match a thrilling
            experience. I love how they let me unwind and forget about
            responsibilities for a while, offering pure fun and adrenaline.
          </p>
        </GlassCard>
      </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {(() => {
                ...
                const topLanguages = stats
                  ? getTopLanguages(stats.languages, 12)
                  : [];
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                I enjoy creating small projects to solve everyday tasks and
                speed up my workflow. These tools help automate repetitive
                actions and make my development process smoother.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                ...
                Passionate about collaborative development and learning from the
                community.
              </p>
            </motion.div>
          </div>
      ...
      >
        <GlassCard className="p-8 text-center" glowEffect>
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
            Always interested in new opportunities and collaborations. Feel free
          ...
          <div className="flex justify-center gap-6">
            ...
            >
              <GlassCard
                className="p-4 hover:shadow-xl transition-transform duration-200 flex items-center justify-center"
                glowEffect
              >
