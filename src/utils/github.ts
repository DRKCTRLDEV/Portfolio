...
const mockRepos: GitHubRepo[] = [
  ...
  },
  {
    ...
    description:
      "A versatile hub for managing and exploring various utilities and tools.",
  ...
  },
  {
    ...
    description:
      "Simple Knockout JS Minesweeper game with intuitive interface and classic gameplay.",
  ...
  },
  {
    ...
    description:
      "A tweak to enhance Spotify experience with additional features and customizations.",
...
export const getCacheStatus = () => {
  ...
  return {
    ...
    userCacheAge: userCache
      ? Date.now() - JSON.parse(userCache).timestamp
      : null,
    reposCacheAge: reposCache
      ? Date.now() - JSON.parse(reposCache).timestamp
      : null,
  };
};
